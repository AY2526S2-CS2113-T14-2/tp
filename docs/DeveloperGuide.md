...
* *Recurring expenses* - expenses that occur on a monthly basis following the same rates (eg Netflix subscription of $
  5.98/month), then you can run `add Netflix Subscription 5.98 entertainment recurring`
...
1. **Sorting by different keywords**
